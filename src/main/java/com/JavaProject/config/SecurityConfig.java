...
public class SecurityConfig {
	...
	{
		http.csrf().disable()
		.authorizeHttpRequests().requestMatchers("/","/register","/signin","/saveUser", "/user/projectdetails","/user/inbox","/inbox/acceptRequest", "/inbox/rejectRequest","/viewprofile").permitAll()
